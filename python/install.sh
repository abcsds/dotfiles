...
pip2 install lightblue --allow-external lightblue --allow-unverified lightblue
pip2 install matplotlib
pip2 install python-osc
pip2 install flake8
pip2 install flake8-docstrings
...
pip3 install lightblue --allow-external lightblue --allow-unverified lightblue
